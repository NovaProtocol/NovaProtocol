...
COMMANDS: list[dict] = [
    ...
    },
    {
        ...
        "output": [
            f"{RED}Private{RESET} - {GREEN}{BOLD}GateKeeper{RESET}      {BLUE}Per-path access-rule gateway · FastAPI · Docker{RESET}",
            f"{RED}Private{RESET} - {GREEN}{BOLD}Portfolio{RESET}       {BLUE}Personal site · FastAPI · Granian · Cloudflare Tunnel{RESET}",
            f"{RED}Private{RESET} - {GREEN}{BOLD}Water Billing{RESET}   {BLUE}Utility CIS · FastAPI · MySQL · Xendit · Docker{RESET}",
            f"{RED}Private{RESET} - {GREEN}{BOLD}PracticeForge{RESET}      {BLUE}Python practice sandbox · FastAPI · Bubblewrap{RESET}",
